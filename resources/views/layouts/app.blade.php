        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{ route('kategori_bencana.index') }}">Kategori Bencana</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('bencana.index') }}">Bencana</a></li>
              </ul>
            </div>
          </li>
          @endif
          <li class="nav-item">
            <a class="nav-link" href="{{ route('pelaporan.index') }}">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title">Laporkan</span>
            </a>
          </li>
        </ul>
      </nav>
